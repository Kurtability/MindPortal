        ...
        switch (answer) {
            case "well":
                ...
                card1Text.textContent =
                    "Enjoy the natural sound of water flowing through a river";
                card2Text.textContent =
                    "Enjoy the soothing sound of rain pouring down";
                card3Text.textContent =
                    "Enjoy the sound of a waterfall deep in a rainforest";
                break;
            case "mild":
                ...
                card1Text.textContent =
                    "Enjoy the first track of these soothing alpha-wave binaural beats~";
                card2Text.textContent =
                    "Enjoy the second track of these soothing alpha-wave binaural beats~";
                card3Text.textContent =
                    "Enjoy the third track of these soothing alpha-wave binaural beats~";
                break;
            case "moderate":
                ...
                card1Text.textContent =
                    "Enjoy the first track of these relaxing delta-wave binaural beats~";
                card2Text.textContent =
                    "Enjoy the second track of these relaxing delta-wave binaural beats~";
                card3Text.textContent =
                    "Enjoy the third track of these relaxing delta-wave binaural beats~";
                break;
            case "severe":
                ...
                card1Text.textContent =
                    "Enjoy a happiness hit, with a dopamine inducing track at 396hz";
                card2Text.textContent =
                    "Enjoy the sound of ocean waves, mixed in with theta waves";
                card3Text.textContent =
                    "Enjoy the sound of positivity inducing binaural beats";
                break;
            default:
                break;
        }
        ...
        switch (num) {
            case 1:
                switch (answer) {
                    ...
                    case "mild":
                        audioPlayer.src =
                            "https://music2relax.com/wp-content/uploads/2017/04/Music-for-Study-focus-better-with-alfa-brainwaves-no-1-45-min.mp3";
                        card1.src =
            ...
            case 2:
                switch (answer) {
                    ...
                    case "mild":
                        audioPlayer.src =
                            "https://music2relax.com/wp-content/uploads/2017/04/Music-for-Study-focus-better-with-alfa-brainwavesno-2-37-min.mp3";
            ...
            case 3:
                switch (answer) {
                    ...
                    case "mild":
                        audioPlayer.src =
                            "https://music2relax.com/wp-content/uploads/2017/04/Music-for-Study-focus-better-with-alfa-brainwaves-no-3-45-min.mp3";
        ...
        <div>
            ...
            <Container fluid className="Audio page">
                <audio id="music" preload="true" autoPlay="true">
                    <source
                        src="https://music2relax.com/wp-content/uploads/2017/04/Music-for-Study-focus-better-with-alfa-brainwaves-no-1-45-min.mp3"
                        type="audio/mpeg"
                    />
                </audio>
                <Row>
                    <OverlayTrigger
                        overlay={
                            <Tooltip id="tooltip">
                                Press the buttons below to change tracks!
                            </Tooltip>
                        }
                        placement="bottom"
                    >
                    ...
                    <Col className="Audio result">
                        <Card className="Audio card border border-2">
                            <Card.Img
                                id="card1"
                                variant="top"
                                src="https://i.pinimg.com/originals/4f/c9/81/4fc981a8d2c3d6eead0c3dfc27b5904a.gif"
                                className="Audio gif"
                            />
                            <Card.Body>
                    ...
                    <Col className="Audio result">
                        <Card className="Audio card border border-2">
                            <Card.Img
                                id="card2"
                                variant="top"
                                src="https://i.imgur.com/F1yv054.jpg"
                                className="Audio gif"
                            />
                            <Card.Body>
                    ...
                    <Col className="Audio result">
                        <Card className="Audio card border border-2">
                            <Card.Img
                                id="card3"
                                variant="top"
                                src="https://i.imgur.com/7atDpKE.jpg"
                                className="Audio gif"
                            />
                            <Card.Body>
